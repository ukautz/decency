...
Announces a change in the MIME file.. See L<Mail::Decency::Core::SessionItem::ContentFilter/mime_has_changed>
...
Header modificaton.. See L<Mail::Decency::Core::SessionItem::ContentFilter/mime_header>
